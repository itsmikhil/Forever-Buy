...
const Add = () => {
  return (
    <form className="flex flex-col justify-start px-12 gap-3 py-3 w-full overflow-x-hidden">
      <h1>Upload Image</h1>
      {/* image input */}
      <div className="flex gap-2">
        <div>
          ...
          <label htmlFor="image1">
            <img className="w-20 h-15 sm:h-20" src={assets.upload_area} alt="" />
          </label>
        </div>
        <div>
      ...
      <h1>Product Sizes</h1>
      <div className="flex gap-2">
        <h1 className="px-2 py-1 bg-gray-300 cursor-pointer">XS</h1>
        <h1 className="px-2 py-1 bg-gray-300 cursor-pointer">S</h1>
        <h1 className="px-2 py-1 bg-gray-300 cursor-pointer">M</h1>
        <h1 className="px-2 py-1 bg-gray-300 cursor-pointer">XL</h1>
        <h1 className="px-2 py-1 bg-gray-300 cursor-pointer">XXL</h1>
      </div>
      <div className="flex items-center gap-2">
        <input className="w-fit" type="checkbox" name="" id="bestseller" />
        <label htmlFor="bestseller">Add to Bestseller</label>
      </div>
      <input className="w-fit bg-black px-6 py-2 text-white cursor-pointer" type="submit" value="ADD" />
    </form>
  );
};
